...
wd <- '~/Gaze following/data_analysis/koku-hamburg/6_9mos/'

# list files
files <- list.files(wd, pattern = '.tsv')

# read in the Tobii participant data and combine into 1 data frame
da <- read.delim(paste0(wd, files), skip = 0)
