...
#Fix misnamed column from one lab

pd_raw <- pd_raw %>%
  unite(participant_gender, partcipant_gender) %>%
  mutate(participant_gender = str_replace(participant_gender, pattern = "NA", replacement = ""))
