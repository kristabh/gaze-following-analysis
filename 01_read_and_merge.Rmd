...
Correcting issue where noerror was coded as na for some lab's session error
...
write.csv(participants_session_error_type, 'metadata/participants_session_errors_all.csv')
