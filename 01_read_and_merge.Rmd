...
td <- td %>% 
  #irl-concordia
    mutate(subid, ifelse(lab == "irl-concordia", gsub("*_", "", .), subid)) %>%
    mutate(subid, ifelse(lab == "irl-concordia", gsub("_*", "", .), subid)) %>%
  #babylab-princeton
    mutate(subid, ifelse(lab == "babylab-princeton", gsub("bl", "", .), subid))
  
  
pd <- pd %>%

#westernsydney-babylab
    mutate(subid, ifelse(lab == "westernsydney-babylab", gsub("mb", "", .), subid))
