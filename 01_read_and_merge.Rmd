...
pd$subid[pd$lab == "irl-concordia" && pd$age_days <= 300] <- paste0("GF6_", toupper(pd$subid[pd$lab == "irl-concordia" && pd$age_days <= 300]))
pd$subid[pd$lab == "irl-concordia" && pd$age_days <= 300] <- paste0("GF12_", toupper(pd$subid[pd$lab == "irl-concordia" && pd$age_days >= 300]))
