...
#babylab-princeton
td$subid[td$lab == "babylab-princeton"] <- sub("bl", "", td$subid[td$lab == "babylab-princeton"])
td$subid[td$lab == "babylab-princeton"] <- sub("manybabies00", "manybabies", td$subid[td$lab == "babylab-princeton"])
td$subid[td$lab == "babylab-princeton"] <- sub("manybabies0", "manybabies", td$subid[td$lab == "babylab-princeton"])
...
#babylab-princeton
#pd$subid[pd$lab == "babylab-princeton"] <- sub("bl", "", pd$subid[pd$lab == "babylab-princeton"])
#pd$subid[pd$lab == "babylab-princeton"] <- sub("manybabies00", "manybabies", pd$subid[pd$lab == "babylab-princeton"])
#pd$subid[pd$lab == "babylab-princeton"] <- sub("manybabies0", "manybabies", pd$subid[pd$lab == "babylab-princeton"])
...
participants_premerge_pd <- pd %>%
  group_by(lab, subid) %>%
  summarize(lines_in_pd = n(), age_days = first(age_days), notes = first(notes), session_error = first(session_error), session_error_type = first(session_error_type), present_pd=TRUE)
