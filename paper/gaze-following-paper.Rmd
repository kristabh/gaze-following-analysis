...
d_participants <- read_csv(here("processed_data/03_data_trial_main.csv"),
                           col_types = cols(
                             comm_lang_2 = col_character(),
                             trial_error_type = col_character()))

#creates 216 parsing errors - all because "na" in original file while column interpreted #logical. Have made issue to change to NA in upstream script
