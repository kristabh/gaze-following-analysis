...
n_6mos_bi <- age %>% filter(lang_group == "bilingual",
                            age_group == "6-9 mo") %>% pull(n)
n_6mos_mono <- age %>% filter(lang_group == "monolingual",
                              age_group == "6-9 mo") %>% pull(n)

n_12mos_bi <- age %>% filter(lang_group == "bilingual",
                             age_group == "12-15 mo") %>% pull(n)
n_12mos_mono <- age %>% filter(lang_group == "monolingual",
                               age_group == "12-15 mo") %>% pull(n)
...
lab_stats <- d_participants %>%
  ...
  arrange(lab, age_group, lang_group)
