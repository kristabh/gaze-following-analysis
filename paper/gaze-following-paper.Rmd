...
```{r fig2, fig.cap="Forest plot for the cross-lab meta-analysis on the proportion of first look. Error bars show 95% confidence intervals.", echo = FALSE, dpi = 1000}
...
```{r fig3, fig.cap="Forest plot for the cross-lab meta-analysis on frequency of looks.Error bars show 95% confidence intervals.", echo = FALSE, dpi = 1000}
...
```{r fig4, fig.cap="Forest plot for the cross-lab meta-analysis on duration of looks.Error bars show 95% confidence intervals.", dpi = 1000}
...
```{r fig5, fig.cap="Forest plot for the cross-lab meta-analysis on latency. Error bars show 95% confidence intervals.", echo = FALSE, dpi = 1000}
