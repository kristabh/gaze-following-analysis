...
* *Insufficient face-to-object saccades* Following Senju and Csibra (2008), we also excluded any infant who did not make at least one face-to-object saccade during the window of analysis in at least three of the six trials.  There were X`r n_shifts$percents$any_sum` (`r round(n_shifts$percents$any_mean*100, 2)`%) infants who were excluded from analyses for this reason.
