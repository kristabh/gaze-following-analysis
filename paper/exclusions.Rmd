...
* *No diagnosed developmental disorders*. We excluded data from `r ndd$percents$any_sum` (`r round(ndd$percents$any_mean*100, 1)`%) infant with parent-reported developmental disorders or sensory impairments.
