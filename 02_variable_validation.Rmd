...
##fix N and Ys with term and preterm
d <- d %>%
...
## fix elp-georgetown: used 40weeks as a reference to categorize premature kids instead of 37 as stablished
d$preterm[d$subid == "elp-georgetown8731"] <- "term"
d$preterm[d$subid == "elp-georgetown9035"] <- "term"
d$preterm[d$subid == "elp-georgetown9029"] <- "term"
d$preterm[d$subid == "elp-georgetown8545"] <- "term"
d$preterm[d$subid == "elp-georgetown8998"] <- "term"
d$preterm[d$subid == "elp-georgetown8955"] <- "term"
d$preterm[d$subid == "elp-georgetown8888"] <- "term"
d$preterm[d$subid == "elp-georgetown8374"] <- "term"
d$preterm[d$subid == "elp-georgetown8725"] <- "term"
